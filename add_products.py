"""
Script pour ajouter des produits dans la collection 'product' (au singulier).
"""
...
def add_products_to_mongodb():
    """Ajoute des produits dans la collection 'product'."""
    try:
        ...
        print(f"Produits existants dans la collection 'product': {products_count}")
        
        if products_count == 0:
            print("Ajout des produits d'exemple dans la collection 'product'...")
            ...
            print("Des produits existent déjà dans la collection 'product'")
        
        # Vérifier le nombre final de produits
        final_count = db.product.count_documents({})
        print(f"Nombre total de produits dans la collection 'product': {final_count}")
